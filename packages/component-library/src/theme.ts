export const theme = {
  ...
  tableInputBackground: 'var(--color-tableInputBackground)',
  tableInputBorder: 'var(--color-tableInputBorder)',
  tableRowBackgroundAlt: 'var(--color-tableRowBackgroundAlt)',
  ...
  sidebarItemBackgroundSelected: 'var(--color-sidebarItemBackgroundSelected)',
  ...
  sidebarDivider: 'var(--color-sidebarDivider)',
