...
import { GoalsProvider } from '#paycheck-planner/GoalsContext';
import { PaycheckPlannerPage } from '#paycheck-planner/PaycheckPlannerPage';
          ...
          >
            ...
            >
              ...
              <Routes>
                ...
                {/* >>> OPTIONAL: SHOW TABS ON PAYCHECK PLANNER TOO <<< */}
                <Route path="/paycheck-planner" element={<MobileNavTabs />} />
