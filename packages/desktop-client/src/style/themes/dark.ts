...
export const pageTextPositive = colorPalette.teal300;
export const pageTextLink = colorPalette.teal300;
export const pageTextLinkLight = colorPalette.teal200;

export const cardBackground = colorPalette.gray800;
export const cardBorder = colorPalette.navy600;
export const cardShadow = colorPalette.navy700;

export const tableBackground = colorPalette.navy800;
export const tableInputBackground = colorPalette.navy700;
export const tableInputBorder = colorPalette.navy600;
export const tableRowBackgroundAlt = '#263e57';
...
export const tableBorderSelected = colorPalette.teal400;
export const tableBorderHover = colorPalette.teal300;
export const tableBorderSeparator = colorPalette.navy400;
export const tableRowBackgroundHighlight = colorPalette.teal800;
...
export const sidebarBackground = colorPalette.slate900;
...
export const sidebarItemAccentSelected = colorPalette.teal300;
export const sidebarItemBackgroundHover = colorPalette.slate800;
export const sidebarItemBackgroundSelected = colorPalette.teal900;
export const sidebarItemText = colorPalette.gray200;
export const sidebarItemTextSelected = colorPalette.teal300;
export const sidebarBudgetName = colorPalette.gray300;
export const sidebarDivider = colorPalette.slate800;
...
export const menuItemTextSelected = colorPalette.teal300;
export const menuItemTextHeader = colorPalette.teal200;
export const menuBorder = colorPalette.navy900;
export const menuBorderHover = colorPalette.teal400;
...
export const buttonPrimaryBackground = colorPalette.teal400;
export const buttonPrimaryBackgroundHover = colorPalette.teal500;
export const buttonPrimaryBorder = buttonPrimaryBackground;
export const buttonPrimaryShadow = 'rgba(77, 184, 188, 0.3)';
...
export const buttonNormalSelectedBackground = colorPalette.teal500;
...
export const upcomingBackground = colorPalette.teal800;
export const upcomingText = colorPalette.teal100;
export const upcomingBorder = colorPalette.teal600;
...
export const formInputBackgroundSelection = colorPalette.teal500;
export const formInputBorder = colorPalette.navy600;
export const formInputTextReadOnlySelection = colorPalette.navy800;
export const formInputBorderSelected = colorPalette.teal400;
...
export const formInputShadowSelected = colorPalette.teal300;
export const formInputTextHighlight = colorPalette.teal400;
export const checkboxText = tableText;
export const checkboxBackgroundSelected = colorPalette.teal400;
export const checkboxBorderSelected = colorPalette.teal400;
export const checkboxShadowSelected = colorPalette.teal600;
export const checkboxToggleBackground = colorPalette.gray700;
export const checkboxToggleBackgroundSelected = colorPalette.teal400;
...
export const pillTextHighlighted = colorPalette.teal300;
export const pillBorder = colorPalette.navy700;
export const pillBorderDark = pillBorder;
export const pillBackgroundSelected = colorPalette.teal700;
export const pillTextSelected = colorPalette.teal100;
export const pillBorderSelected = colorPalette.teal400;
...
export const floatingActionBarBackground = colorPalette.teal600;
